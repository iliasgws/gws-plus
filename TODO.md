...
- [x] 1. **Fix crash after scrolling in Documents section**
...
- [x] 2. **Fix navigation state & bottom bar desync when switching tabs during a Quiz or Message Thread**
...
- [x] 3. **Quiz back button: use liquid glass and leave it floating alone**
...
- [x] 4. **Make all buttons use liquid glass across the app**
...
- [x] 5. **Ensure search box and nav bar properly use liquid glass**
